...
**FOLDER: Supporting Files** contains files which can be used for testing or support data processing 
    1. runways.m file plots runways and boxes at runway ends
    2. plot_single_traj.m file plots a selected trajectory 
    3. ellipse.m file holds an ellipse function which is called in the main files to plot elliptical states
